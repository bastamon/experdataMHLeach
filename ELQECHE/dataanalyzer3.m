clear;clc;close all;
% [ref,temp] = xlsread('./WSN_20190117_234421.xlsx','Results');
% ref(1:end,5)=datenum(temp(2:end,5));
% comp = xlsread('./WSN_20190117_234421.xlsx','Compute');
% save ( 'ELQECHE4.mat','comp', 'ref');
% clear;clc;
...
save ( 'ELQECHE_simpled4.mat','comp', 'ref','simples');




clear;
load('ELQECHE_simpled4.mat');
