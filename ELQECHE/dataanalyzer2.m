clear;clc;close all;
% [ref,temp] = xlsread('./WSN_20190115_171249.xlsx','Results');
% ref(1:end,5)=datenum(temp(2:end,5));
% comp = xlsread('./WSN_20190115_171249.xlsx','Compute');
% save ( 'ELQECHE3.mat','comp', 'ref');
% clear;clc;
...
save ( 'ELQECHE_simpled3.mat','comp', 'ref','simples');




clear;
load('ELQECHE_simpled3.mat');
