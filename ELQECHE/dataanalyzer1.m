clear;clc;close all;
% [ref,temp] = xlsread('./WSN_20190110_093154.xlsx','Results');
% ref(1:end,5)=datenum(temp(2:end,5));
% comp = xlsread('./WSN_20190110_093154.xlsx','Compute');
% save ( 'ELQECHE2.mat','comp', 'ref');
% clear;clc;
...
save ( 'ELQECHE_simpled2.mat','comp', 'ref','simples');




clear;
load('ELQECHE_simpled2.mat');
