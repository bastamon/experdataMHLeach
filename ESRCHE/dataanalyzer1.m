clear;clc;close all;
% [ref,temp] = xlsread('./WSN_20190103_025131.xlsx','Results');
% ref(1:end,5)=datenum(temp(2:end,5));
% comp = xlsread('./WSN_20190103_025131.xlsx','Compute');
% save ( 'ESRCHE1.mat','comp', 'ref');
% clear;clc;
...
save ( 'ESRCHE_simpled1.mat','comp', 'ref','simples');




clear;
load('ESRCHE_simpled1.mat');
